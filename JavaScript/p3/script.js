const moviesdata=document.getElementById('movies')
const data=[
    {
      "Title": "Avatar",
      "Year": "2009",
...
data.forEach(function(mv)
{
    ...
    movieimg.src=mv.Images[0];
    movieimg.alt=mv.Title;
    const imagetitle=document.createElement('h2')
    imagetitle.textContent=mv.Title
    const Director=document.createElement('p')
    Director.textContent="Director:"+mv.Director
    const btn=document.createElement('button')
    btn.addEventListener('click',incr)
    btn.textContent="Add to Cart"
    moviediv.append(movieimg,imagetitle,Director,btn)
    moviediv.classList.add('movie')
    moviesdata.appendChild(moviediv)
